...
<body>
			...
			<form:form id="emitirParecerForm" enctype="multipart/form-data"
				...
				<div class="form-group">
					...
					<div class="col-sm-10 field-value parecer">
						<label><a
							href="<c:url value="/usuario/${projeto.autor.id}/detalhes" ></c:url>">${projeto.autor.nome}</a></label>
					</div>
				</div>
				<div class="form-group form-item">
					<label for="observacao" class="col-sm-2 control-label">Observação
						(Diretor):</label>
					<div class="col-sm-10 field-value parecer">
				...
				<div class="form-group form-item">
					<label for="posicionamento" class="col-sm-2 control-label"><span
						class="required">*</span> Posicionamento:</label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					<div class="form-item">
						<label for="parecer" class="col-sm-2 control-label"><span
							class="required">*</span> Parecer:</label>
						<div class="col-sm-10">
							<textarea id="parecer" name="parecer" class="form-control"
								rows="8" placeholder="Parecer" required="required"></textarea>
						</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="confirmacaoModalLabel">Confirmação
									dos dados</h4>
							</div>
							<div class="modal-body">
								Nome do Projeto = ${projeto.nome }<br> 
								Posicionamento =
								<div id="divpos"></div>
	...
	<script type="text/javascript">
		var conceptName = $("#posicionamento").find(":selected").val();
		var div = document.getElementById("divpos");
		div.textContent = conceptName;
